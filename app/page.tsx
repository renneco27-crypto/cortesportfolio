          ...
          <div className="container">
            ...
            <div className="proj-grid">
              ...
              <div className="proj-card reveal">
                ...
                <h3>StudyUp</h3>
                <p>
                  StitchAI is a study tool designed to turn structured CSV data into comprehensive, interactive study
                  notes and quizzes. By importing formatted CSV files, the app instantly populates a customized dashboard
                  with diverse learning modules including flashcards, 4-option multiple-choice quizzes, fill-in-the-blank
                  identification, true/false questions, and list enumeration allowing users to seamlessly track their
                  progress and review streaks. <strong>Hint:</strong> look in feed to try the app code: test.
                </p>
                <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap", marginTop: "1.4rem" }}>
                  <a
                    className="proj-link"
                    href="https://median.co/share/nmpwama#androidphone"
                    target="_blank"
                    rel="noopener"
                  >
                    Try the app
                  ...
                  <a
                    className="proj-link"
                    href="https://t.me/+iBqel2uwqGA0NzRl"
                    target="_blank"
                    rel="noopener"
                  >
                    Telegram Bot
              ...
              <div className="proj-card reveal">
                ...
                <h3>For the Blind — Keyboard Touches</h3>
                <p>
                  A browser extension designed for blind and visually impaired users that provides fast speech feedback,
                  keyboard navigation, and screen exploration tools. Features include speech feedback while navigating
                  web pages, text/link/button/heading reading, caret tracking, selected text reading, element labels
                  announced before their role, Navigator Mode with Alt + C shortcut, and Escape key support for exiting
                  navigation states.
                </p>
                <a
                  className="proj-link"
              ...
              <div className="proj-card reveal">
                ...
                <p>
                  ...
                  Verification (Google Face Recognition &amp; Nodding System), Device Integrity Protection
                  (Anti-Developer Options), and Seamless Reporting &amp; Excel Export.
                </p>
                <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap", marginTop: "1.4rem" }}>
                  <a
                    className="proj-link"
                    href="https://www.mediafire.com/file/e5mltyozkd9goji/ACLC_QR.apk/file"
                    target="_blank"
                    rel="noopener"
                  >
                    Download APK
                  ...
                  <a
                    className="proj-link"
                    href="https://attendancemaker-tsjz.onrender.com"
                    target="_blank"
                    rel="noopener"
                  >
                    Main Gateway
                  ...
                  <a
                    className="proj-link"
                    href="https://teachesinterfaceattendanceaclc.onrender.com/"
                    target="_blank"
                    rel="noopener"
                  >
                    Teacher Interface
